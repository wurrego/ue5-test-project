...
UNREALROOTPATH = /mnt/nvme1n1p1/UE5/UnrealEngine-5.1.1
GAMEPROJECTFILE =/mnt/nvme1n1p1/UE5/ue5-projects/aws-codecommit/TestProject-ue5.1.1/TestProject.uproject

TARGETS = \
	TestProject-Linux-Debug  \
	TestProject-Linux-DebugGame  \
	TestProject-Linux-Test  \
	TestProject-Linux-Shipping  \
	TestProject \
	TestProjectEditor-Linux-Debug  \
	TestProjectEditor-Linux-DebugGame  \
	TestProjectEditor-Linux-Test  \
...
TestProject-Linux-Debug:
	 $(PROJECTBUILD) TestProject Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

TestProject-Linux-DebugGame:
	 $(PROJECTBUILD) TestProject Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

TestProject-Linux-Test:
	 $(PROJECTBUILD) TestProject Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)
...
TestProjectEditor-Linux-Debug:
	 $(PROJECTBUILD) TestProjectEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

TestProjectEditor-Linux-DebugGame:
	 $(PROJECTBUILD) TestProjectEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

TestProjectEditor-Linux-Test:
	 $(PROJECTBUILD) TestProjectEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)
